...
## story 87
* agent.details OR agent.extras
    - utter_ask_again
  
## story ticket format 01
...
* agent.extras{"searchType":"translate", "searchWord":"pen", "language":"malayalam"}
...
* agent.extras{"searchWord":"rat"}
  - slot{"searchWord":"rat"}
  - utter_specific
* agent.extras{"searchType":"translation"}
...
* agent.extras{"searchWord":"global"}
